...
class Config():
    def __init__(self) -> None:
        ...
        self.data_root_dir = os.path.join(self.current_workdir, 'datasets')
        self.weights_root_dir = os.path.join(self.current_workdir, 'checkpoints', 'backbone')
        self.weights = {
        ...
        self.rand_seed = 7
        run_sh_file = [f for f in os.listdir('.') if 'train.sh' == f] + [os.path.join('scripts', f) for f in os.listdir('scripts') if 'train.sh' == f]
